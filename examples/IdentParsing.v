...
MLtac Run ocaml:{{
  ...
  let to_bool b = if b <> 0 then [%constr "true"] else [%constr "false"]
  ...
  let byte_to_rocq_ascii (c : int) =
    ...
    [%constr "Ascii %{b1} %{b2} %{b3} %{b4} %{b5} %{b6} %{b7} %{b8}"]
  ...
  let id_to_string (id: Id.t) =
    String.fold_right (fun c str ->
        ...
        [%constr "String %{ascii_char} %{str}"]) (Id.to_string id) [%constr "EmptyString"]
...
(* 1000 A *)
Profile Time Compute (let x := ml_ident_to_string  in String.length x).
